  ...
  },
  {
    ...
    blocks: [
      ...
      { ul: [
        ...
        '<b>Termene ASI</b>: câte zile au rămas sau cu câte zile a fost depășit termenul.',
  ...
  },
  {
    ...
    blocks: [
      ...
      { ul: [
        ...
        '<b>Sigiliu</b> (doar la neregulile grave): bifați dacă ați aplicat sigiliul în baza acestei nereguli.',
  ...
  },
  {
    ...
    blocks: [
      { ul: [
        ...
        '<b>Istoric</b>: toate controalele, grupate pe luni, cu căutare după obiectiv, administrator sau dată și cu filtrele În desfășurare / Încheiate. Fiecare control arată, scris: numărul de nereguli, câte nu sunt trecute în PV, amenzile cu stadiul lor și termenul ASI.',
        '<b>Calendar</b>: anul și luna se schimbă separat. În fiecare zi vedeți controalele (violet = în desfășurare, albastru închis = încheiat) și bulinele termenelor (albastru = termen de plată, roșu = termen ANAF sau ASI). Atingeți o zi ca să vedeți lista completă și butonul „Control nou în această zi”.',
      ] },
    ],
  },
  {
